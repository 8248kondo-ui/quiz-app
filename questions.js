...
const questionDatabase = [
    ...
    },
    {
        ...
        "answer": 1,
        "explanation": "コンストラクタの定義ルール：\n  1. クラス名と全く同じ名前\n  2. 戻り値の型を記述しない（voidも含め不可）\n\n  public void Animal() { } はvoidが付いているため、\n  コンストラクタではなくvoidを返す通常のメソッドとして扱われます。\n\n・1番：引数なし、戻り値なし、クラス名一致 → 正しいコンストラクタ\n・3番：引数あり → 正しいコンストラクタ\n・4番：アクセス修飾子なし → 有効なコンストラクタ（パッケージプライベート）",
        "category": "総合問題"
    },
    {
        "id": 228,
